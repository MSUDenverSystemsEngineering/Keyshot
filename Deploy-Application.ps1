...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\keyshot_win64_11.2.0.102.exe" -Parameters '/S /AllUsers /FlexLM=27070@vmwas32.winad.msudenver.edu /NO_UPDATE /NO_CLOUD' -WindowStyle 'Hidden'
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		...
		If (Test-Path "$env:Public\Desktop\Keyshot 11.lnk") {
			Remove-Item "$env:Public\Desktop\Keyshot 11.lnk" -Force
		}
		Else {
			Write-Log -Message "Shortcut not detected." -Source 'Pre-Installation' -LogType 'CMTrace'
		}
		If (Test-Path "$env:Public\Desktop\KeyShot 11 Resources.lnk") {
			Remove-Item "$env:Public\Desktop\KeyShot 11 Resources.lnk" -Force
		}
		Else {
			Write-Log -Message "Shortcut not detected." -Source 'Pre-Installation' -LogType 'CMTrace'
		}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUPV5bjn79cqISt4MJfjDeZ0pV
# RpSgghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFNoLsz6j/DL0Jm2woEzT1T8q8JtYMA0GCSqGSIb3DQEBAQUABIIBgDlXT2Ku
# XP9+BRdDWU20hgXAjQEItvNDpdWWWSEJz+qt97QRDHNlhLJTt83fsPeoWaCTDotu
# V6eYs+soTQGSNPuFYcT3C7RBU4G2hkaUE7rJ+mV0mwOsw942msJoVDJGs8foFgBB
# KIoi0e0+lHPhL0g9iFPAEh1idwI5tDtFm5bLg30zGTbTbURP3W7hVDZwy7mrn6YZ
# 7xZblIYlTyNJCDJwYrvw8dw5m9CGeD4I/TxVfFH8tdbXRyhZHYL5PUyPsDWfnhX4
# T1hYheM22xoWDE3A2uks8BnSjZDl1kOzvtPCEJr3pw9Jq1FLnVw/Oa5H0fqGajwQ
# jhPgb97ReDZ/70cPGPLM+Rrj5+fyMuCxsq8k14eP9N46FU4Fk+XGVOCsNm14F5rD
# yC2qX9YOnI5JVIQftYb448S+fVM+3/TZc9AUpnPWculcnM/Z06dGIpxDXSb0SdCa
# f2G1we7F4gnnjF6880HIYdtnXU+rVI4gTVMzGe6Adja9dpFKbYcD6AVOlQ==
